		...
		<div class="main-content">
			...
			<div class="right-content">
				...
				<div class="video-inner">
					<iframe src="video/Imagine dragons-Demons X spiderman M-V.mp4" width="100%" height="500px" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> 
				</div>
				<div class="clear"> </div>
